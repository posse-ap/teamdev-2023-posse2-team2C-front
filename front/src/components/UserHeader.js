...
export default function PrimarySearchAppBar() {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={handleMenuClose}>出品・主催</MenuItem>
      <MenuItem onClick={handleMenuClose}>レンタル・参加イベント</MenuItem>
    </Menu>
  );
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" className="bg-white" elevation={0}>
        <Toolbar>
          ...
          >
            <Typography variant="subtitle" component="p" className="text-black mr-2">
              100pt/100coin
            </Typography>
            <IconButton
              size="large"
